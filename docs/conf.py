# -*- coding: utf-8 -*-
#
# napari-image-stacker documentation build configuration file, created by
...
project = u'napari-image-stacker'
copyright = u'2015, Robin Koch'
author = u'Robin Koch'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'napari-image-stacker Documentation',
     [author], 1)
]
